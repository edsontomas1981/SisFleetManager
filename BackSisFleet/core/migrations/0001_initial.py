# Generated by Django 4.2.23 on 2025-09-01 22:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome_razao_social', models.CharField(blank=True, max_length=150, null=True, verbose_name='Nome/Razão Social')),
                ...
                ('tipo_usuario', models.CharField(choices=[('motorista', 'Motorista'), ('cliente', 'Cliente'), ('admin', 'Administrador')], default='cliente', max_length=20)),
                ('is_verified', models.BooleanField(default=False)),
                ('tipo_plano', models.CharField(choices=[('gratis', 'Grátis'), ('premium', 'Premium')], default='gratis', max_length=20)),
